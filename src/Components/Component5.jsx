...
import { Development } from '../API/API4';
const Component5 = () => {
    return (
                    ...
                    {Development &&
                        Development.map((data) => (
                            <div key={data.id} className="deleteHr">
                                <h5
                                    className={`h-[full] text-2xl font-bold before:mr-[10px] before:content-[attr(data-id)] before:text-primary mb-[15px]`}
                                    data-id={'0' + data.id}
                                >
                                    {data.title}
                                </h5>
                    ...
                    {Development &&
                        Development.map((data) => (
                            <img
                                ...
                                src={data.URL}
                                alt=""
                                className="max-w-[346px] w-[full] h-[full] mb-[49px] last:mb-0"
                            />
                        ))}
                </div>
            </div>
