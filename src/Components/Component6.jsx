        ...
        <div>
            ...
            <div className="w-[1112px] m-auto md:w-[375px] md:mx-[-35px]">
                <div className="w-full h-[780px] md:w-[full] md:h-[200px]">
                    <img src="/image/session8/bg.jpg" alt="" className=" w-full h-[780px]  md:h-[200px] md:w-[375px] " />
                    <div className="w-full h-[780px] bg-primary opacity-70 relative bottom-[780px]  left-0 md:h-[200px] md:bottom-[200px] md:pb-[200px]">
                    </div>
