    ...
    return (
        <div>
            <div className="w-[1112px] h-20 flex flex-row items-center m-auto md:w-full md:justify-between md:mt-[20px] md:h-auto md:mb-[75.83px]">
                <img src="../public/image/Group.png" alt="" className="w-[162px] mr-[229px] md:w-[124px] md:h-[21.17px] md:mr-0 " />
                ...
                <IoMdMenu onClick={showSidebar} color="#2E3A59" size={30} className={`cursor-pointer mdpc:hidden md:inline ${sidebar ? "!hidden" : ""}`} />
                <nav className={sidebar ? "nav-menu active mdpc:hidden" : "nav-menu mdpc:hidden"}>
                    <ul className="nav-menu-items mdpc:hidden" >
