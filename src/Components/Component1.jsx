    ...
    return (
        <div>
            <div className="w-[1112px] mx-auto flex flex-row justify-between align-bottom mb-[71px] md:w-full md:mb-[73px]">
                <div className="w-full h-full flex flex-col justify-start md:w-full">
                    <div>
                        ...
                        <p className="w-[668px] text-[25px] leading-[37.5px] mb-[36px] md:w-full md:text-xl md:leading-[25px] md:mb-[72px]">Expert Blockchain Development Services for Secure and Decentralized Blockchain Technology</p>
                    </div>
                ...
                <img src="./image/session2/System 1.png" alt=""
            ...
            <div className=" w-[1112px] mx-auto flex flex-col items-center  mb-[136px] md:w-full md:md:mb-[95px]">
                <p className="text-[16px] text-center mb-[30px] md:">Our clients include 150 Global Brands, Silicon
                    Valley Founders
                </p>
