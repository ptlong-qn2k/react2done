    ...
    return (
        <div>
            <div className="w-[1112px] h-[325px] m-auto bg-primary text-center pt-[69px] md:w-[375px] md:h-[369px] md:ml-[-35px] md:pt-[72px] ">
                ...
                <button className="focus:outline-none hover:text-green-600 focus:text-blue-500 w-[282px] h-[70px] bg-white rounded-[5px] text-[25px] font-bold text-primary md:w-[260px] md:h-[65px] md:text-xl">
                    Get in Touch
                </button>
            </div>
            <div className="w-full h-[713px] pt-[69px] md:pt-[57px] md:h-auto">
                <div className="w-[1112px] m-auto mb-[61px] md:w-full">
                    ...
                    <p className="w-[923px] px-14 text-[25px] text-center mx-auto md:w-full md:px-0 md:text-xl md:leading-[25px]">
                        Our blockchain developers provide you the quality you need and the flexibility you want using
                            ...
                            <div className="w-[437px] h-[79px] text-[13px] flex flex-row justify-between md:w-full md:grid md:h-auto md:grid-cols-3 md:grid-rows-2 md:gap-5">
                                {ListIcon &&
                                    ListIcon.map((data) => (
                                        <div
                                            key={data.id}
                                            className="w-[52px] flex flex-col items-center justify-between"
                                        >
                            ...
                            <div className="w-[506px] h-[63px] text-sm flex flex-row gap-1 justify-between items-center md:w-[275px] md:grid md:h-auto  md:gap-y-[11px] md:gap-x-2 md:m-auto md:grid_ok">
                                {List4 &&
                                    List4.map((data) => (
                                        <div
                                            key={data.id}
                                            className="h-full border border-solid px-2 rounded-[5px] text-center flex flex-col justify-center md:w-auto md:px-2"
                                        >
                                            {data.Name}
                                        </div>
                                    ))}
