            ...
            <div className="w-[1112px] mx-auto flex flex-row justify-between align-bottom mb-[71px] md:w-full md:mb-[73px]">
                <div className="w-full h-full flex flex-col justify-start md:w-full">
                    <div>
                        ...
                        <p className="w-[668px] text-[25px] leading-[37.5px] mb-[36px] md:w-full md:text-xl md:leading-[25px] md:mb-[72px]">
                            Expert Blockchain Development Services for Secure and Decentralized Blockchain Technology
                        </p>
                    </div>
